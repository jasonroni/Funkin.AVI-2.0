	...
	public static final judges:Array<Judgement> = [
		{
			name: "sick",
			score: 350,
			health: (PlayState.curStage == "waltRoom" ? 100 : 12),  // THE REASON WHY IT'S LENIENT ON MERCY IS DUE TO THE MECHANIC - don
			accuracy: 100,
			timing: 45,
			timingCap: 45,
			comboStatus: "MFC"
		},
		{
			name: "good",
			score: 150,
			health: (PlayState.curStage == "waltRoom" ? 50 : 8),
			accuracy: 85,
			timing: 90,
			timingCap: 90,
			comboStatus: "GFC"
		},
		{
			name: "bad",
			score: 50,
			health: (PlayState.curStage == "waltRoom" ? 20 : 3),
			accuracy: 50,
			timing: 125,
			timingCap: 125,
			comboStatus: 'FC'
		},
		{
			name: "shit",
			score: -50,
			health: (PlayState.curStage == "waltRoom" ? -50 : -150),
			accuracy: 0,
			timing: 150,
			timingCap: 150,
			comboStatus: null
