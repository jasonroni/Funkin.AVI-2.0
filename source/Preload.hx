...
class Preload extends meta.MusicBeat.MusicBeatState {
    ...
    override public function create() {
      ...
      /*  #if desktop
       ...
       // backgroundGroup = new FlxTypedGroup<FlxSprite>();
        ...
        bg = new FlxSprite().loadGraphic(Paths.menuImage('menuBG')); //Placeholder
		bg.screenCenter();
        bg.alpha = 0;
		add(bg);
        ...
        for (i in assetStack.keys()) {
            ...
            switch(assetStack[i]) {
                ...
                case PreloadType.atlas:
                    var preloadedCharacter:gameObjects.Character = new gameObjects.Character();
        ...
        FlxTween.tween(FlxG.camera, {alpha: 0}, 0.5, {startDelay: 1,
            onComplete: function(tween:FlxTween){
                ...
                MusicBeatState.switchState(new LanguageState());
                    ...
                    Main.switchState(this, new meta.state.TitleState());
                //}
            }
        });
            }
