...
class LegacyState extends MusicBeatState
{
	...
	override function create()
	{
        ...
        addSong('Isolated-Legacy', 3, 'face', FlxColor.fromRGB(60, 60, 60));
		addSong('Lunacy-Legacy', 3, 'face', FlxColor.fromRGB(60, 60, 60));
		addSong('Delusional-Legacy', 3, 'face', FlxColor.fromRGB(60, 60, 60));
		addSong('Mercy-Legacy', 3, 'face', FlxColor.fromRGB(60, 60, 60));
		addSong('Malfunction-Legacy', 3, 'face', FlxColor.fromRGB(60, 60, 60));
