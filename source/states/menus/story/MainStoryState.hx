...
class MainStoryState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...Main.gameWeeksE.length)
		{
			var weekThing:MenuItem = new MenuItem(0, yellowBG.y + yellowBG.height + 10, i, true);
	...
	override function update(elapsed:Float)
	{
		...
		txtWeekTitle.text = Main.gameWeeksE[curWeek][3].toUpperCase();
	...
	function changeWeek(change:Int = 0):Void
	{
		...
		if (curWeek >= Main.gameWeeksE.length)
			curWeek = 0;
		if (curWeek < 0)
			curWeek = Main.gameWeeksE.length - 1;
	...
	function updateText()
	{
		...
		var stringThing:Array<String> = Main.gameWeeksE[curWeek][0];
