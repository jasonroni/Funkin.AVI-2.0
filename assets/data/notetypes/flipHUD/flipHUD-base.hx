function generateNote(newNote)
{
	...
	else
	{
		...
		newNote.frames = Paths.getSparrowAtlas('FLIPNOTE_assets', 'data/notetypes/flipHUD/skins/base');
		newNote.animation.addByPrefix(stringSect + 'Scroll', stringSect + '0');
		newNote.playAnim(stringSect + 'Scroll');
...
function generateSplash(splashNote, noteData)
{
	...
	{
		splashNote.frames = Paths.getSparrowAtlas('FLIPnoteSplashes', 'data/notetypes/flipHUD/skins/base');
