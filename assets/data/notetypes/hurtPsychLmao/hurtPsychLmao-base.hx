function generateNote(newNote)
{
	...
	else
	{
		...
		newNote.frames = Paths.getSparrowAtlas('HURTNOTE_assets', 'data/notetypes/hurtPsychLmao/skins/base');
		newNote.animation.addByPrefix(stringSect + 'Scroll', stringSect + '0');
		newNote.playAnim(stringSect + 'Scroll');
...
function generateSplash(splashNote, noteData)
{
	...
	{
		splashNote.frames = Paths.getSparrowAtlas('HURTnoteSplashes', 'data/notetypes/hurtPsychLmao/skins/base');
