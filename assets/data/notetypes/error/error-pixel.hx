function generateNote(newNote)
{
	...
	newNote.loadGraphic(Paths.image("error/skins/pixel/ERRORNOTE_assets", 'data/notetypes'), true, 17, 17);
...
function generateSustain(newNote)
{
	...
	newNote.loadGraphic(Paths.image("error/skins/pixel/HOLD_assets", 'data/notetypes'), true, 7, 6);
