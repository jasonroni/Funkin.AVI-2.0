...
function onCreate()
{
	...
	var mickeyEmitter:FlxEmitter = new FlxEmitter(-2099.8, 1620.4);
	for (i in 0 ... 100)
	{
		...
		mickeyParticle.animation.addByPrefix('laugh', 'mickParticle idle', 19, true);
		mickeyParticle.animation.play('laugh');
	...
	mickeyEmitter.start(false, FlxG.random.float(0.3, 0.4), 100000);
